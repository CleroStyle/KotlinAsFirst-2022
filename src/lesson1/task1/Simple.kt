 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = ((deg*PI)/180.0 + ((min/60.0)*PI)/180.0 + ((sec/3600.0)*PI)/180.0)
 ...
 */
fun numberRevert(number: Int): Int = number/100+(number/10)*10+(number/100)*100
